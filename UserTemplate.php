...
<div id="content">
    <div id="container">
        ...
        <?php
        $devID = $_GET["devID"];
        $UserQuery = "SELECT Bugs.title, Bugs.description, Bugs.bugposted, Bugs.bugfixed, Bugs.status, Users.name, Users.country FROM Bugs, Users WHERE Bugs.user_ID LIKE Users.user_ID AND Users.user_ID LIKE $devID ";
