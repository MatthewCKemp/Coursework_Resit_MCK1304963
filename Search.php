...
<div id="content">
    <div id="container">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $Search = "SELECT Bugs.title, Bugs.bugposted, Users.name FROM Bugs, Users WHERE Users.user_ID LIKE Bugs.user_ID AND Users.name LIKE '%".$Dev."%' OR Bugs.description LIKE '%".$Key."%'";
            ...
            if (mysqli_num_rows($result) > 0 ){
                ...
                while ($rows = mysqli_fetch_assoc($result)) { //Outputs data in each row.
                    echo "<tr><td>" . $rows["Bugs.title"] . "</td><td>" . $rows["Bugs.bugposted"] . "</td><td>" . $rows["Users.name"] . "</tr></td>";
                }
                echo"</table>";
            } else {
