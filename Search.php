...
<div id="content">
    <div id="container">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $Search = "SELECT Bugs.title, Bugs.bugposted, Users.name FROM Bugs, Users WHERE Bugs.bug_ID LIKE Users.bug_ID AND Users.name LIKE '%".$Dev."%' OR Bugs.description LIKE '%".$Key."%'";
