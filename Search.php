...
<div id="content">
    <div id="container">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $Search = "SELECT Bugs.title, Bugs.bugposted, Users.name FROM Bugs, Users WHERE Users.user_ID LIKE Bugs.user_ID AND Users.name = $Dev OR Bugs.description LIKE '%".$Key."%'";
