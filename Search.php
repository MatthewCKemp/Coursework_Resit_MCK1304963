...
<div id="content">
    <div id="container">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $Search = "SELECT Bugs.title, Bugs.bugposted, Users.name FROM Bugs, Users WHERE Users.user_ID LIKE Bugs.user_ID OR Users.name LIKE '$Dev' AND Bugs.description LIKE '%".$Key."%'";
