    ...
    <body>
        ...
        <div id="content">
            <div id="container">
                ...
                <?php
                $_GET["bugID"];
                $BugQuery = "SELECT Bugs.title, Bugs.description, Bugs.bugposted, Bugs.bugfixed, Bugs.status, Users.name, Users.country FROM Bugs, Users WHERE Bugs.user_ID = Users.user_ID AND Bugs.bug_ID = '$bugID' ";
